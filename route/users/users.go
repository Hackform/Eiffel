...
func (rr *userroute) Register(r chi.Router) {
	...
	r.Get("/id/:userid", func(w http.ResponseWriter, r *http.Request) {
	...
	r.Get("/id/:userid/private", func(w http.ResponseWriter, r *http.Request) {
	...
	r.Post("/:code", func(w http.ResponseWriter, r *http.Request) {
		...
		render.PlainText(w, r, fmt.Sprintf("create new user %s", code))
	})
}
